package com.example.zimuquan.circleofletters.im;
...
/*token*/
    public static String test = "L3oOXmtzl/8Fr0PeeK0P4w4PiEkkVZYHTQOCZQ7U0FjzxzjCBkgxOFgItl7WiMXgeRku/Nl80RkoJVBHp6zuMw==";
    String yidong = "98VoJ+VxB+r2VjhSJfwwAQIQ/1+HXSzwPXc+lrVVik202zsoiH46FAgKLJ9rSqNm+uSeFRWeOa41JQ6nA5/EjA==";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.im_main_layout);
        init();
    }
    ...
    public void connect(View view) {
        RongIM.connect(test, new RongIMClient.ConnectCallback() {
            @Override
            ...
            public void onSuccess(String s) {
                Log.e("", "连接成功—————>" + s);
                Toast.makeText(MainActivity1.this, "连接成功" + s, Toast.LENGTH_SHORT).show();
            }
