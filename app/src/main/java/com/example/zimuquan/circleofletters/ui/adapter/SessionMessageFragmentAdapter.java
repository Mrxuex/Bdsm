...
public class SessionMessageFragmentAdapter extends RecyclerView.Adapter<SessionMessageFragmentAdapter.MyViewHolder> {
    private List<Article> mItems = new ArrayList<>();
    private LayoutInflater mInflater;

    private OnItemClickListener mClickListener;

    public SessionMessageFragmentAdapter(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.session_message_item, parent, false);
