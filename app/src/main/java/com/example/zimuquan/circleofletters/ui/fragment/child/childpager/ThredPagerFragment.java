...
import com.example.zimuquan.circleofletters.ui.adapter.HomeNewPeopleAdapter;
...
public class ThredPagerFragment extends SupportFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ThredPagerFragment newInstance() {

        Bundle args = new Bundle();

        ThredPagerFragment fragment = new ThredPagerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.homepage_fragment_homepager_thred, container, false);
