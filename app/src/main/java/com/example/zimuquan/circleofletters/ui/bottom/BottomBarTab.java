package com.example.zimuquan.circleofletters.ui.bottom;
...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_btn_select));

            if (mTvTitle != null)
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tab_btn_select));
        } else {
