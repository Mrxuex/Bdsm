 ...
 */
    ...
    public class HomeCircleAdapter  extends RecyclerView.Adapter<HomeCircleAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = mInflater.inflate(R.layout.item_home_cirle, parent, false);
